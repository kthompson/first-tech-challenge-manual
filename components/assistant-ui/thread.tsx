    ...
    <div className="aui-thread-welcome-suggestions grid w-full gap-2 pb-4 @md:grid-cols-2">
      {[
        ...
        },
        {
          ...
          label: "restrictions?",
          action: "What are the robot size restrictions?",
        },
        {
          title: "What safety requirements",
          label: "must teams follow?",
          action: "What safety requirements must teams follow?",
        },
      ...
      <ThreadPrimitive.If running>
        <ComposerPrimitive.Cancel asChild>
          <Button
            ...
            variant="default"
            size="icon"
            className="aui-composer-cancel size-[38px] rounded-full border-2 border-red-500 bg-red-500 hover:bg-red-600 shadow-lg"
  ...
  return (
    <MessagePrimitive.Root asChild>
      <div
        ...
        data-role="assistant"
      >
        <div className="aui-assistant-message-content mx-2 p-4 leading-7 break-words rounded-2xl bg-white dark:bg-gray-800 shadow-md border border-gray-200 dark:border-gray-700">
